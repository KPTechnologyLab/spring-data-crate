 ...
 *
 * <p>Types that can be mapped directly because they neither need deeper inspection nor nested conversion.</p>
 * 
...
public class CustomConversions {
  ...
  private static final Logger LOG = getLogger(CustomConversions.class);
  private static final String READ_CONVERTER_NOT_SIMPLE = "Registering converter from %s to %s as reading converter although it doesn't convert from a Crate supported type! You might want to check your annotation setup at converter implementation.";
  private static final String WRITE_CONVERTER_NOT_SIMPLE = "Registering converter from %s to %s as writing converter although it doesn't convert to a Crate supported type! You might want to check your annotation setup at converter implementation.";
  ...
  /**
   * Returns whether we have a custom conversion registered to write into a Crate native type. The returned type might
   ...
   * of the given Crate native target type.
   *
   * @param sourceType must not be {@literal null}.
   * @param requestedTargetType
   * @return
