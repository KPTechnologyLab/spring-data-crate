...
public interface CrateOperations {
     ...
     * @param handler must not be {@literal null}. 
     */
    <T> BulkOperartionResult<T> execute(CrateBulkAction action, CrateBulkActionResponseHandler<T> handler) throws DataAccessException, CrateSQLActionException;
     ...
     */
    <T> BulkOperartionResult<T> bulkInsert(List<T> entities, Class<T> entityClass);
     ...
     * @return Results containing the details of the bulk operation
     */
    <T> BulkOperartionResult<T> bulkInsert(List<T> entities, Class<T> entityClass, String tableName);
     ...
     * @return Results containing the details of the bulk operation
     */
    <T> BulkOperartionResult<T> bulkUpdate(List<T> entities, Class<T> entityClass);
     ...
     * @return Results containing the details of the bulk operation
     */
    <T> BulkOperartionResult<T> bulkUpdate(List<T> entities, Class<T> entityClass, String tableName);
     ...
     * @return Results containing the details of the bulk operation
     */
	<T> BulkOperartionResult<Object> bulkDelete(List<Object> ids, Class<T> entityClass);
